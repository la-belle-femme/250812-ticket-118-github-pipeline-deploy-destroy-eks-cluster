...
# IAM Policy for GitHub Actions - EKS and Infrastructure Management
resource "aws_iam_policy" "github_actions_eks" {
  name        = "eks-mgmt-${random_id.bucket_suffix.hex}"
  description = "Comprehensive policy for GitHub Actions to manage EKS and all infrastructure resources"
    ...
    Statement = [
      {
        ...
        Action = [
          ...
          # EC2 permissions
          "ec2:*",
          # Comprehensive IAM permissions (includes all the inline policies you added)
          "iam:*",
          # CloudWatch and Logs
          "logs:*",
          "cloudwatch:*",
